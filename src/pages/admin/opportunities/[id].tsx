...
export default function OpportunityEditor() {
  ...
  return (
    <Layout classNames="mt-12 mx-auto w-full py-10">
      <section className="mx-auto max-w-3xl rounded bg-white/10 p-5">
        <Image
        ...
        <p className=" my-3 text-center">
          A{" "}
          <span className="text-semibold rounded border border-warning p-1 text-warning">
            Yellow border
          </span>{" "}
        ...
        <form className="w-full" onSubmit={handleSubmit}>
          ...
          <div className="form-control w-full ">
            ...
            <select
              className={classNames(
                "select-bordered select w-full max-w-xs border-4",
            ...
            <div className="form-control w-full">
              ...
              <div className="form-control w-full">
                ...
                <textarea
                  ...
                  className={classNames(
                    "row textarea-bordered textarea w-full border-4 focus:border-transparent focus:ring-2  focus:ring-blue-600",
                ...
                <label className="label">
                  ...
                  <span className="badge badge-error label-text">
              ...
              <div className="form-control w-full">
                ...
                />
                <label className="label">
                  <span className="label-text ">Company Employees</span>
                </label>
                <input
                  type="text"
          ...
          <div className="card-actions">
            <button type="submit" className="btn-warning btn-block btn mt-4">
              Submit
            </button>
          </div>
        </form>
