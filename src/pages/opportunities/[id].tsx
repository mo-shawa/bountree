	...
	if (error) {
		return (
			<Layout classNames="bg-b-blue-dark flex justify-center">
				<div className="py-10 bg-white rounded-full flex flex-row justify-between items-center p-4 my-4 absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
...
function Top({ post }: Partial<IOpportunity>) {
	return (
		<div className="w-full text-white flex flex-row justify-between items-center mt-12 pb-10 border-b">
			<div className="h-full flex justify-between items-center w-full">
				...
				<div className="flex flex-col-reverse md:flex-row gap-4 md:gap-10 w-max items-center">
					<Link
						className="group rounded border p-2 whitespace-nowrap hover:bg-b-yellow hover:text-black transition-colors float-left"
						href="/opportunities"
					>
						All Opportunities
						<svg
							...
							viewBox="0 0 448 512"
							className="inline ml-1.5 w-2.5 fill-white hover transition-colors group-hover:fill-black"
						>
					...
					<a
						target="_blank"
						className="h-12 w-12 hover:bg-b-yellow transition-colors rounded-full p-2 border"
...
function PrimarySection({ post }: Partial<IOpportunity>) {
	return (
		<div className="grid grid-cols-6 border-b pb-10 md:pb-0 md:border-b-0">
			<div className="col-span-6 md:col-span-4 py-5 md:border-b">
				...
				<div className="grid max-w-xl grid-cols-2 gap-4 grid-rows-2 py-10 ">
					<GridIcon text="5 People" icon="/static/svg/opportunity/people.svg" />
					<GridIcon text="1994" icon="/static/svg/opportunity/birthday.svg" />
					<GridIcon
						text="Finance"
						icon="/static/svg/opportunity/industry.svg"
					/>
					<a target="_blank" href={post.company.url}>
			...
			<div className="col-span-6 md:col-span-2 border rounded-xl mt-6  mx-auto md:mx-0 md:w-auto w-full max-w-sm md:ml-10 flex flex-col justify-between p-5">
				<div>
					...
					<ul className=" list-disc ml-10">
						{new Array(5).fill("Lorem ipsum dolor sit amet").map((item, i) => {
							return (
				...
				<a target="_blank" className="flex " href="https://google.com">
...
function GridIcon({ icon, text }: { icon: string; text: string }) {
	return (
		<div className="col-span-1 row-span-2 md:row-span-1 flex items-center gap-4">
...
function SecondarySection({ post }: Partial<IOpportunity>) {
	return (
		<div className="grid grid-cols-6 border-b">
			<div className="col-span-6 md:col-span-4 py-5 ">
				...
				<p className=" max-w-2xl my-4 ">
					...
					excepturi obcaecati ipsum repudiandae cum molestiae architecto
					sapiente accusamus magni. Velit odio doloremque dolores nam ullam
					inventore nemo maxime numquam similique.
				</p>
...
function FeedbackSection({ post }: Partial<IOpportunity>) {
	return (
		<div className="pb-10">
			<div className="col-span-6 md:col-span-4 py-5 ">
