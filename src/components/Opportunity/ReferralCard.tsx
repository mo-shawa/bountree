  ...
  return (
    <div
      className={classNames(
        "col-span-6 mx-auto flex h-min w-full max-w-sm flex-col justify-between rounded-xl bg-white p-5  text-b-blue-dark shadow lg:col-span-2 lg:mx-0 lg:mt-12 lg:w-auto",
        mobile ? "mb-10 flex lg:hidden" : "hidden lg:flex"
      )}
    >
      <div className="mb-4">
        <div className="flex items-center justify-between border-b  pb-3">
          ...
          <div className="dropdown-bottom dropdown-end dropdown">
            <div data-tip="Share Externally" className="tooltip tooltip-left">
              <label
                tabIndex={0}
                className="btn-sm btn-circle btn bg-transparent text-gray-500 hover:bg-gray-200 hover:text-gray-700 "
              >
                <ShareIcon className="h-4 fill-current " />
              </label>
            </div>
            <div className="card">
              <ul
                tabIndex={0}
                className="dropdown-content rounded-box card-body bg-base-100 p-2 shadow-2xl "
              >
                <li>
                  <div className="form-control mb-2">
                    <label className="input-group">
                      ...
                      <button
                        ...
                        className="input-group-btn btn tooltip tooltip-left normal-case"
                      >
                        <ClipboardDocumentIcon className="h-4 fill-current " />
                      </button>
                    </label>
                  </div>
                </li>
                <li>
                  <div className="form-control">
                    <a
                      target="_blank"
                      className=" btn-success btn-block btn gap-2 border p-2 normal-case"
        ...
        <ul className=" mx-4 list-disc xl:mx-8">
